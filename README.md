...
```bash
git clone https://github.com/0xdroidrun/droidrun.git
cd droidrun
pip install -e .
```
...
1. Download the DroidRun Portal APK from the [DroidRun Portal repository](https://github.com/0xdroidrun/droidrun-portal)
